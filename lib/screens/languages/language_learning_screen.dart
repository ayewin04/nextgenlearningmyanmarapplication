...
// ===== CHINESE PINYIN =====
  static const List<Map<String, dynamic>> chineseAlphabet = [
    ...
    {'letter': 'b', 'burmese': 'ပေါ်', 'romanization': 'b'},
    {'letter': 'p', 'burmese': 'ဖော်', 'romanization': 'p'},
    {'letter': 'm', 'burmese': 'မော်', 'romanization': 'm'},
    {'letter': 'f', 'burmese': 'ဖော', 'romanization': 'f'},
    {'letter': 'd', 'burmese': 'သိင်', 'romanization': 'd'},
    {'letter': 't', 'burmese': 'ထိင်', 'romanization': 't'},
    {'letter': 'n', 'burmese': 'နိင်', 'romanization': 'n'},
    {'letter': 'l', 'burmese': 'လိန်', 'romanization': 'l'},
    {'letter': 'g', 'burmese': 'ကိင်', 'romanization': 'g'},
    {'letter': 'k', 'burmese': 'ခိင်', 'romanization': 'k'},
    {'letter': 'h', 'burmese': 'ဟိင်', 'romanization': 'h'},
    {'letter': 'j', 'burmese': 'ကျီ', 'romanization': 'j'},
    {'letter': 'q', 'burmese': 'ချီ', 'romanization': 'q'},
    {'letter': 'x', 'burmese': 'ရှီ', 'romanization': 'x'},
    {'letter': 'zh', 'burmese': 'ကျီ(ရ်)', 'romanization': 'zh'},
    {'letter': 'ch', 'burmese': 'ချီ(ရ်)', 'romanization': 'ch'},
    {'letter': 'sh', 'burmese': 'ရှီ(ရ်)', 'romanization': 'sh'},
    {'letter': 'r', 'burmese': 'ရိင်', 'romanization': 'r'},
    {'letter': 'z', 'burmese': 'ကျိင်', 'romanization': 'z'},
    {'letter': 'c', 'burmese': 'ချိင်', 'romanization': 'c'},
    {'letter': 's', 'burmese': 'စိင်', 'romanization': 's'},
{'letter': 'y', 'burmese': 'ရီ', 'romanization': 's'},
{'letter': 'w', 'burmese': 'ဝူ', 'romanization': 's'},
  ];

  // ===== CHINESE VOWELS =====
  static const List<Map<String, dynamic>> chineseVowels = [
     {'letter': 'a', 'burmese': 'အာ', 'romanization': 'a'},
    {'letter': 'o', 'burmese': 'အော်', 'romanization': 'o'},
    {'letter': 'e', 'burmese': 'အယ်', 'romanization': 'e'},
    {'letter': 'i', 'burmese': 'ရီ', 'romanization': 'i'},
    {'letter': 'u', 'burmese': 'ဝူ', 'romanization': 'u'},
    {'letter': 'ü', 'burmese': 'ယွီ', 'romanization': 'ü'},
  ];
